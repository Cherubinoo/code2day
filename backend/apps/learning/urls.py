...
from .views import (
    ...
    AdminReadingPassageSquadImportView,
...
urlpatterns = [
    ...
    path("admin/v2/reading-passages/import-squad/", AdminReadingPassageSquadImportView.as_view(), name="admin-reading-passage-import-squad"),
