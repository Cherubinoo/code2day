...
component folders (student/, staff/, hod/, leadership/, ja/, admin/) plus
common.py for genuinely cross-role views. Every name from every submodule is
re-exported here so `from .views import AnyViewClass` (as urls.py already
does) keeps working completely unchanged."""
